...
void initialize(int& end_time, unsigned int& queue_limit, double& arrival_rate, double& departure_rate);
...
int main(void)
/*  Pre: The user must supply the number of time intervalsthe simulation isto run,
    ...
    Uses: Classes Runway, Plane, Random and functions run_idle, initialize. */
{
    ...
    unsigned int queue_limit;    // size of Runway queues
    int flight_number = 0;
