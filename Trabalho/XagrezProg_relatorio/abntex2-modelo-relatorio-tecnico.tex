...
% ---
\titulo{Programação Jogo de Xadrez}
\autor{Equipe Mirabilis}
\local{Brasil}
\data{2018,20 de novembro}
\instituicao{
...
\preambulo{Código escrito no intuito de por em prática os conceitos trabalhados na disciplina de Programação 3}
% ---
